...
include('config.php');
$oid=$_GET['id'];
$sql="SELECT * FROM `outsider_query` WHERE `id`=$oid";
               ...
               <div class="sidebar_blog_2">
                  ...
                  <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           ...
                           <li><a href="flatowner.php">> <span>Flat Owner Table</span></a></li><li><a href="tenantregistrationtable.php">> <span>Tenant Registration Table</span></a></li><li><a href="#">> <span>Media Gallery</span></a></li>
                        </ul>
                     </li>
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>Outside Query Send Feedback</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
       ...
       <div class="white_shd full margin_bottom_30">
          <div class="full graph_head">
             <div class="heading1 margin_0">
                <h2>Outside Feedback Data</h2>
             </div>
          </div>
          <div class="table_section padding_infor_info">

    <div class="container col-sm-12 col-md-12 col-lg-12">
        <form action="sendoutsidequerymail1.php" method="post">
           <div class="mx-5 mb-3">
           ...
           <small id="helpId" class="form-text text-muted"></small>
            ...
            <div class="mb-3">
               ...
               <textarea class="form-control" name="mail" id="" rows="3"></textarea>
            </div>
            
            
    
                <button style="background: green;border: 0;padding: 10px 24px;color: #fff;transition: 0.4s;" type="submit" class="btn mb-3">Send mail</button>

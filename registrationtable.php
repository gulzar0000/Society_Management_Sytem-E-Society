                ...
                <table class='table'>
                   ...
                   while ($rows=mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                       ...
                       <td>{$rows['email']}</td>
                       <td>{$rows['roomtype']}</td>
                       <td><a class='btn cur-p btn-primary' href='editregistrationtable.php?id={$rows['id']}' role='button'>Edit</a>
                       <a class='btn cur-p btn-danger' href='deleteregistration.php?id={$rows['id']}' role='button'>Delete</a></td>
                    </tr>
                    ";
                   }
                                echo"</tbody>
